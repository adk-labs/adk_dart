...
- 최신 상태: 2026-05-11 기준 `adk-python`에서 registry 검색 경로가 제거되어, Dart도 `search_skills`와 registry fallback을 제거했다. 최신 문서는 `docs/worklog/2026-05-11-latest-ref-sync.md`를 기준으로 한다.
