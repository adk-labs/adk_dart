...
- [x] eval-set orchestrator parity (`agent_evaluator`) with repeated-run aggregation, legacy evalset migration/validation helpers, and file/directory evaluation entrypoint
