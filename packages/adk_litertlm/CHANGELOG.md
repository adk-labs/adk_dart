...
- Synced LiteRT-LM runtime model bindings with latest core features.
...
- Synced release with `adk_dart` `2026.7.11`, including ADK 2.0
  Managed Agent support and Interactions API integration.

## 2026.6.6

- Initial release of `adk_litertlm` package.
