...
| --- | --- | --- | --- |
| Package/version baseline | ✅ | `adkVersion`, package versions | `adk_dart`, `adk`, `adk_mcp`, `flutter_adk`, and `adk_litertlm` are aligned on `2026.9.7`; exported ADK baseline is `2.7.0`. |
