...
| --- | --- | --- | --- |
| Package/version baseline | ✅ | `adkVersion`, package versions | `adk_dart`, `adk`, `adk_mcp`, `flutter_adk`, and `adk_litertlm` are aligned on `2026.8.17`; exported ADK baseline is `2.2.0`. |
